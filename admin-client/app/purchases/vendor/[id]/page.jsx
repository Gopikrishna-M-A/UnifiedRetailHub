...
export default function Dashboard({ params }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if(isEditMode) {
          const purchaseRes = await axios.get(`/api/vendors?id=${id}`)
  ...
  const handleSave = async () => {
    try {
      setIsLoading(true)
      if (isEditMode) {
        await axios.patch(`/api/vendors?id=${params.id}`, vendor)
      } else {
                ...
                <div className='grid gap-6'>
                  <div className='grid grid-cols-5 gap-4'>
                    <div className='grid col-span-1 gap-3'>
                      ...
                      <Select
                        value={vendor?.contactPersons?.salutation}
                        defaultValue='Mr'
                        onValueChange={(value) =>
                          handleNestedInputChange(
                            "primaryContact",
                    ...
                    <div className='grid col-span-2 gap-3'>
                      ...
                      <Input
                        ...
                        name='firstName'
                        type='text'
                        value={vendor?.contactPersons?.firstName}
                        onChange={(e) =>
                          handleNestedInputChange(
                            "primaryContact",
                            "firstName",
                    ...
                    <div className='grid col-span-2 gap-3'>
                      ...
                      <Input
                        ...
                        name='lastName'
                        type='text'
                        value={vendor?.contactPersons?.lastName}
                        onChange={(e) =>
                          handleNestedInputChange(
                            "primaryContact",
                            "lastName",
                  ...
                  <div className='grid gap-3'>
                    ...
                    <Input
                      ...
                      name='email'
                      type='email'
                      value={vendor?.contactPersons?.email}
                      onChange={(e) =>
                        handleNestedInputChange(
                          "primaryContact",
                          "email",
                  ...
                  <div className='grid grid-cols-2 gap-4'>
                    <div className='grid gap-3'>
                      ...
                      <Input
                        ...
                        name='workPhone'
                        type='tel'
                        value={vendor?.contactPersons?.workPhone}
                        onChange={(e) =>
                          handleNestedInputChange(
                            "primaryContact",
                            "workPhone",
                    ...
                    <div className='grid gap-3'>
                      ...
                      <Input
                        ...
                        name='mobile'
                        type='tel'
                        value={vendor?.contactPersons?.mobile}
                        onChange={(e) =>
                          handleNestedInputChange(
                            "primaryContact",
                            "mobile",
