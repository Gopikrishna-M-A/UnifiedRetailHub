...
export default function PurchaseForm() {
    ...
    if (index !== null) {
      ...
      if (name === "quantity" || name === "rate") {
        newEntries[index].amount =
          newEntries[index].quantity * newEntries[index].rate
      }
  ...
  const addEntry = () => {
    setFormData({
      ...
      entries: [
        ...formData.entries,
        { product: "", quantity: 0, rate: 0, MRP: 0, amount: 0 },
      ],
    })
  }
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-2 gap-4 mb-8'>
              ...
              <div>
                ...
                <Select
                  onValueChange={(value) =>
                    handleSelectChange(value, "paymentTerms")
                  }
                  ...
                  <TableRow key={index}>
                    <TableCell>
                      <Select
                        value={entry.product}
                        onValueChange={(value) =>
                          handleSelectChange(value, "product", index)
                        }>
                        <SelectTrigger>
