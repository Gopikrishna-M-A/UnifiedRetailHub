...
const Cart = () => {
  ...
  const handlePhoneChange = (event) => {
    ...
    const userWithPhoneNumber = users.find((user) => user.phone === phoneNumber)
  ...
  const employeeInfo = currentEmployee ? (
    <div className="bg-secondary text-secondary-foreground flex justify-between items-center px-5 py-2 text-sm mb-2">
      <div className="flex gap-2 items-center">
      <CircleUser className='w-4 h-4 text-primary'/>
        <div className="text-primary font-medium">Cashier:</div>
        <div className="text-muted-foreground">{currentEmployee?.label}</div>
      </div>
    ...
    {employeeInfo}
      ...
      <div className='h-40 flex flex-col gap-2 bg-white dark:bg-gray-950 items-start p-5 w-full border-t absolute bottom-0 left-0 right-0'>
        <div className='flex justify-between w-full'>
          ...
          <div className='text-lg font-bol'>{formatPrice(total)}</div>
        </div>
                    ...
                    <div className='flex'>
                      ...
                      <div className='w-3/5'>
                        ...
                        <div className='grid grid-cols-3 gap-2 mt-2'>
                          <Button
                            onClick={() => {
                              setReceived((prev) => parseInt(prev) + 50)
                            }}
                            variant='outline'>
                            {formatPrice(50)}
                          </Button>
                          <Button
                            onClick={() => {
                              setReceived((prev) => parseInt(prev) + 60)
                            }}
                            variant='outline'>
                            {formatPrice(60)}
                          </Button>
                          <Button
                            onClick={() => {
                              setReceived((prev) => parseInt(prev) + 100)
                            }}
                            variant='outline'>
                            {formatPrice(100)}
                          </Button>
                          <Button
                            onClick={() => {
                              setReceived((prev) => parseInt(prev) + 200)
                            }}
                            variant='outline'>
                            {formatPrice(200)}
                          </Button>
                          <Button
                            onClick={() => {
                              setReceived((prev) => parseInt(prev) + 500)
                            }}
                            variant='outline'>
                            {formatPrice(500)}
                          </Button>
                          <Button
                            onClick={() => {
                              setReceived((prev) => parseInt(prev) + 2000)
                            }}
                            variant='outline'>
                            {formatPrice(2000)}
                          </Button>
